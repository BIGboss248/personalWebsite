...
- **Core Pages**:
  ...
  - Projects Archive (Gallery listing all projects with Filter, Search, and Category sections)
  - Project Detail / Case Study (Deep-dive into a single project: Context, Tech Stack, Challenges, Features, and Outcomes)
...
- **Rendering Strategy**: Next.js App Router.
  ...
  - Projects Archive: Static Site Generation (SSG) with client-side dynamic search/filter logic.
  - Project Detail: Static Site Generation (SSG) / Dynamic Paths (generateStaticParams) with ISR on update.
